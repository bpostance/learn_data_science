     ...
     def __update_clusters(self, medoids):
         ...
         for index_point in range(len(self.__pointer_data)):
             ...
             for index in range(len(medoids)):
                 dist = manhattan_distance(self.__pointer_data[index_point], self.__pointer_data[medoids[index]])
         ...
         while (index_neighbor < self.__maxneighbor):
             ...
             for point_index in range(0, len(self.__pointer_data)):
                 if point_index not in self.__current:
                     ...
                     distance_current = manhattan_distance(self.__pointer_data[point_index], self.__pointer_data[current_medoid_index])
                     
                     # from the point to candidate median
                     distance_candidate = manhattan_distance(self.__pointer_data[point_index], self.__pointer_data[candidate_medoid_index])
                     ...
                     if ( (point_medoid_index != candidate_medoid_index) and (point_medoid_index != current_medoid_cluster_index) ):
                         distance_nearest = manhattan_distance(self.__pointer_data[point_index], self.__pointer_data[point_medoid_index])
     ...
     def __find_another_nearest_medoid(self, point_index, current_medoid_index):
         ...
         for index_medoid in self.__current:
             if (index_medoid != current_medoid_index):
                 other_distance_candidate = manhattan_distance(self.__pointer_data[point_index], self.__pointer_data[current_medoid_index])
     ...
     def __calculate_estimation(self):
         ...
         for index_cluster in range(0, len(self.__clusters)):
             ...
             for index_point in cluster:
                 estimation += manhattan_distance(self.__pointer_data[index_point], self.__pointer_data[index_medoid])
